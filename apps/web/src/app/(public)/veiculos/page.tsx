  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8">
        ...
        <Suspense
          fallback={
            <div className="rounded-card bg-sunken h-[13rem] animate-pulse sm:h-[15.5rem] lg:h-[13rem]" />
          }
        >
          <Filters />
        </Suspense>
...
async function Results({ params }: { params: Record<string, string | string[] | undefined> }) {
  ...
  return (
    <>
      ...
      <h2 className="text-faint mt-8 text-sm font-normal">
    ...
    <nav className="mt-12 flex items-center justify-center gap-1" aria-label="Paginação">
      {meta.has_previous && (
        <Link
          ...
          rel="prev"
          className="rounded-btn text-muted hover:bg-sunken flex size-10 items-center justify-center transition-colors"
