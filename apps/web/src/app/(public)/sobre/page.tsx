...
export default function SobrePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="text-silver-400 mt-6 text-lg leading-relaxed text-pretty">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        {[
          ...
          <div key={title} className="rounded-card bg-ink-900 ring-ink-800 p-6 ring-1">
            <span className="rounded-btn text-brand-400 ring-ink-800 bg-ink-900 flex size-11 items-center justify-center shadow-sm ring-1">
              <Icon className="size-5" />
            </span>
            <h2 className="text-silver-100 mt-4 font-semibold">{title}</h2>
