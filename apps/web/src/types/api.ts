...
export interface paths {
  ...
  '/api/v1/articles/featured': {
    ...
    /**
     * Artigo em destaque no topo da home
     * @description `null` quando nenhum artigo está marcado — o topo do site fica com a foto
     ...
     */
    get: operations['get_featured_article_api_v1_articles_featured_get'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface operations {
  ...
  get_featured_article_api_v1_articles_featured_get: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['ArticleSummaryOut'] | null;
        };
      };
    };
  };
