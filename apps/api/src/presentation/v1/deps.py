...
def get_featured_article_use_case(repo: ArticleRepositoryDep) -> FeaturedArticleUseCase:
    return FeaturedArticleUseCase(repo)
...
FeaturedArticleDep = Annotated[FeaturedArticleUseCase, Depends(get_featured_article_use_case)]
